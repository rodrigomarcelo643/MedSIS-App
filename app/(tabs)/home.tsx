  ...
  const quickLinks: HomeQuickLink[] = [
    {
      ...
      title: "Announcements",
      description:
        "Stay informed with the latest updates and essential details you won't want to miss.",
      color: "#8C2323",
    ...
    },
    {
      ...
      description:
        "Don't miss out-mark your calendar with key dates for assembles, sports and celebrations",
      color: "#8C2323",
      count: events.length,
