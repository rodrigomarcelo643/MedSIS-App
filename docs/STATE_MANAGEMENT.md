...
Because MedSIS App is heavily dependent on the current student's status, standard state management is relegated to React Contexts instead of heavy third-parties like Redux.
